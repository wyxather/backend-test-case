...
export async function find_book_by_id(id) {
  const found_book = await prisma.book.findUnique({ where: { id } });
  return found_book;
}

export async function insert_new_book(new_book) {
...
export async function delete_book_by_id(id) {
...
export async function insert_or_replace_book_by_id(id, new_book) {
...
export async function update_book_by_id(id, book) {
